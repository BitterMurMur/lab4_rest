...
import app.company2.CompanyModule as CompanyModule

import app.company2.DB as DB
...
class Storage:
    ...
    def save(self):
        pickle.dump((self.company.director, self.company.leadEngineers, self.company.engineers), open("data/company2/data.dat", "wb"))
        
    def load(self):
        (self.company.director, self.company.leadEngineers, self.company.engineers) = pickle.load(open("data/company2/data.dat", "rb"))
...
class DBStorage:
    ...
    def connect(self):
            self.con = sqlite3.connect('data/company2/Companies.db', detect_types=sqlite3.PARSE_DECLTYPES)
